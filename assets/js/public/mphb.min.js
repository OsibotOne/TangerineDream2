	...
	l(function() {
		...
		MPHB.DateRules = can.Construct.extend({}, {
			...
			getMaxAdvanceDate: function() {
				var t = this.getOption("maxAdvanceDate");
				return t ? MPHB.Utils.cloneDate(t) : null
			},
			clear: function() {
			...
			initSliders: function() {
				if (!this.slidersLoaded) {
					...
					this.sliderEl.addClass("flexslider mphb-flexslider mphb-gallery-slider").flexslider(t), this.slidersLoaded = !0
				}
			}
			...
			init: function(t) {
				...
				}), this.rules.minAdvance = l.map(t.min_advance_reservation, function(t) {
					return new MPHB.Rules.MinAdvanceDaysRule(t)
				}), this.rules.maxAdvance = l.map(t.max_advance_reservation, function(t) {
					return new MPHB.Rules.MaxAdvanceDaysRule(t)
				})
			},
			...
			combineRules: function(t, e) {
				...
				switch (t) {
					...
					case "maxStay":
						...
						break;
					case "minAdvance":
						n = MPHB.Utils.arrayMin(l.map(e, function(t) {
							return t.min
						}));
						a = new MPHB.Rules.MinAdvanceDaysRule({
							season_ids: [0],
							room_type_ids: [0],
							min_advance_reservation: n
						});
						break;
					case "maxAdvance":
						n = MPHB.Utils.arrayMax(l.map(e, function(t) {
						...
						a = new MPHB.Rules.MaxAdvanceDaysRule({
							season_ids: [0],
							room_type_ids: [0],
							max_advance_reservation: n
						})
				}
				return a
			},
			...
			getMinAdvance: function(t) {
				return t ? this.getActualRule("minAdvance", this.getToday(), t).min : this.getActualCombinedRule("minAdvance", this.getToday()).min
			},
			getMaxAdvance: function(t) {
				return t ? this.getActualRule("maxAdvance", this.getToday(), t).max : this.getActualCombinedRule("maxAdvance", this.getToday()).max
			},
			getMinCheckInDate: function(t) {
				var e = this.getMinAdvance(t);
				return 0 < e ? l.datepick.add(MPHB.Utils.cloneDate(this.getToday()), e, "d") : MPHB.Utils.cloneDate(this.getToday())
			},
			getMaxAdvanceDate: function(t) {
				var e = this.getMaxAdvance(t);
				return 0 < e ? l.datepick.add(MPHB.Utils.cloneDate(this.getToday()), e, "d") : null
			},
			...
			isEarlierThanMinAdvanceDate: function(t, e) {
				var a = this.reservationRules.getMinCheckInDate(e);
				return null != a && MPHB.Utils.compareDates(t, a, "<")
			},
			isLaterThamMaxAdvanceDate: function(t, e) {
				var a = this.reservationRules.getMaxAdvanceDate(e);
				return null != a && MPHB.Utils.compareDates(t, a, ">")
			}
		}), MPHB.TermsSwitcher = can.Construct.extend({}, {
			init: function(t, e) {
				var a = t.children(".mphb-terms-and-conditions");
				0 < a.length && t.find(".mphb-terms-and-conditions-link").on("click", function(t) {
			...
			compareDates: function(t, e, a) {
				t = MPHB.Utils.formatDateToCompare(t), e = MPHB.Utils.formatDateToCompare(e);
				if (null == a) return e < t ? 1 : t < e ? -1 : 0;
				switch (a) {
					case ">":
						return e < t;
					case ">=":
			...
			updateBillingInfo: function(t, e) {
				var a = this,
					i = t.val();
			...
			getSelectedGateway: function() {
				var t = this.getSelectedGatewayEl();
				return t && 0 < t.length ? t.val() : ""
			},
			getSelectedGatewayEl: function() {
				var t = this.element.find('[name="mphb_gateway_id"]');
				return 1 == t.length ? t : t.filter(":checked")
			},
			...
			init: function(t, e) {
				...
				var a = this;
				l(".mphb-room-details").each(function() {
					a.updateRatePrices(l(this))
			...
			updateCheckoutInfo: function() {
				...
				e.hideErrors(), e.showPreloader(), clearTimeout(this.updateInfoTimeout), this.updateInfoTimeout = setTimeout(function() {
					...
					e.currentInfoAjax = l.ajax({
						...
						success: function(t) {
							t.hasOwnProperty("success") ? t.success ? t.data && e.setCheckoutData(t.data) : e.showError(t.data.message) : e.showError(MPHB._data.translations.errorHasOccured)
						},
						error: function(t) {
		...
		}), (a = jQuery)("#mphb-render-checkout-login").click(function(t) {
			t.preventDefault(), t.stopPropagation();
			var e = a(this).parents(".mphb-login-form-wrap").find(".mphb-login-form");
			e.hasClass("mphb-hide") ? e.removeClass("mphb-hide") : e.addClass("mphb-hide")
			...
			createPaymentIntent: function(t, e) {
				var n = this;
				var room_type_id = jQuery('.mphb_sc_checkout-form').find('input[name="mphb_room_details[0][room_type_id]"]').val();
				var room_type_idBackand = jQuery('.mphb_sc_checkout-form').find('input[name="roomType"]').val();
				...
				return new Promise(function(a, i) {
					MPHB.post("create_stripe_payment_intent", {
						...
						room_type_idBackand:room_type_idBackand,
					},  {
						success: function(t) {
							if (t.hasOwnProperty("success"))
								if (t.success) {
			...
			confirmCardPayment: function(t) {
				return this.api.confirmCardPayment(t.client_secret, {
			...
			completeCardPayment: function(t) {
				return this.saveToCheckout("payment_method", this.payments.currentPayment), this.saveToCheckout("payment_intent_id", t.id), !0
			},
			completeSourcePayment: function(t) {
				return this.saveToCheckout("payment_method", this.payments.currentPayment), this.saveToCheckout("source_id", t.id), t.redirect && t.redirect.url && 0 < t.redirect.url.length && this.saveToCheckout("redirect_url", t.redirect.url), !0
			},
			...
			setupPrice: function(t, e) {
				this.priceWrapper.children(".mphb-price, .mphb-price-period, .mphb-tax-information").remove(), 0 < t && "" != e && this.priceWrapper.append(e)
			},
			showError: function(t) {
			...
			updateCheckInLimitations: function(t) {
				void 0 === t && (t = !0);
				var e = this.retrieveCheckInLimitations();
				this.checkInDatepicker.setOption("maxAdvanceDate", e.maxAdvanceDate)
			},
			...
			isCheckOutDateNotValid: function(t, e, a, i) {
				var n = !this.isDirectBooking || this.roomTypeData.canCheckOut(e);
				return n = n && MPHB.HotelDataManager.myThis.dateRules.canCheckOut(e), null === e || MPHB.Utils.formatDateToCompare(e) < MPHB.Utils.formatDateToCompare(a) || MPHB.Utils.formatDateToCompare(e) > MPHB.Utils.formatDateToCompare(i) || !MPHB.HotelDataManager.myThis.reservationRules.isCheckOutSatisfy(t, e, this.searchRoomTypeId) || !n
			},
			...
			init: function(t, e) {
				...
				var s = MPHB.HotelDataManager.myThis.reservationRules.getMinCheckInDate(this.roomTypeId);
				t.hide().datepick({
			...
			isDirectBooking: !1,
			init: function(t, e) {
				this._super(t, e), this.isDirectBooking = "1" == MPHB._data.settings.isDirectBooking, 0 === this.roomTypeId && (this.roomTypeId = e.form.hasOwnProperty("roomTypeId") ? e.form.roomTypeId : 0)
			},
			getDatepickSettings: function() {
				return {
					...
					onDate: this.proxy(function(t, e) {
						...
						if (e) {
							var i = MPHB.Utils.compareDates(t, MPHB.HotelDataManager.myThis.reservationRules.getMinCheckInDate(this.roomTypeId), "<"),
								n = null !== this.getMaxAdvanceDate() && MPHB.Utils.compareDates(t, this.getMaxAdvanceDate(), ">"),
								s = !i && !n && MPHB.HotelDataManager.myThis.reservationRules.isCheckInSatisfy(t, this.roomTypeId) && MPHB.HotelDataManager.myThis.dateRules.canCheckIn(t);
							this.isDirectBooking ? (a = this.form.roomTypeData.fillDateData(a, t, "checkIn"), s = s && this.form.roomTypeData.canCheckIn(t)) : (this.form.roomTypeData.isEarlierThanToday(t) && (a.dateClass += " mphb-past-date", a.title += " " + MPHB._data.translations.past), a = MPHB.HotelDataManager.myThis.fillDateCellData(a, t, "checkIn")), s && (a.selectable = !0)
						} else a.dateClass += " mphb-extra-date";
						return a.selectable ? a.dateClass += " mphb-date-selectable" : a.dateClass += " mphb-unselectable-date", a
					}),
				...
				return {
					onDate: this.proxy(function(t, e) {
						...
						if (e) {
							...
							var l = !n && !s && MPHB.HotelDataManager.myThis.reservationRules.isCheckOutSatisfy(i, t, this.roomTypeId) && MPHB.HotelDataManager.myThis.dateRules.canCheckOut(t);
							this.isDirectBooking ? (a = this.form.roomTypeData.fillDateData(a, t, "checkOut", i), l = l && this.form.roomTypeData.canCheckOut(t)) : (this.form.roomTypeData.isEarlierThanToday(t) && (a.dateClass += " mphb-past-date", a.title += " " + MPHB._data.translations.past), a = MPHB.HotelDataManager.myThis.fillDateCellData(a, t, "checkOut", i))
						} else a.dateClass += " mphb-extra-date";
						return l && (a.selectable = !0), a.selectable ? a.dateClass += " mphb-selectable-date" : a.dateClass += " mphb-unselectable-date", a
					}),
					onSelect: this.proxy(function(t) {
			...
			fillDateData: function(t, e, a, i) {
				...
				switch (this.getDateStatus(e)) {
					...
					case MPHB.HotelDataManager.ROOM_STATUS_LATER_MAX_ADVANCE:
						n.push(MPHB._data.translations.notAvailable), this.isDateBookingCheckOut(e) && (s.push("mphb-booked-date"), s.push("mphb-date-check-out"), s.push("mphb-available-date"))
				}
			...
			canCheckInDirect: function(t) {
				return !MPHB.HotelDataManager.myThis.typeRules[this.originalId] || MPHB.HotelDataManager.myThis.typeRules[this.originalId].canCheckIn(t)
			},
			canCheckOutDirect: function(t) {
				return !MPHB.HotelDataManager.myThis.typeRules[this.originalId] || MPHB.HotelDataManager.myThis.typeRules[this.originalId].canCheckOut(t)
			}
		}), MPHB.Rules.BasicRule("MPHB.Rules.MaxAdvanceDaysRule", {}, {
			max: null,
			init: function(t) {
				this._super(t), this.max = 0 != t.max_advance_reservation ? t.max_advance_reservation : 3652
			},
			verify: function(t, e) {
				var a = l.datepick.add(MPHB.Utils.cloneDate(MPHB.HotelDataManager.myThis.today), this.max, "d");
				return MPHB.Utils.compareDates(t, a, "<=")
			}
		}), MPHB.Rules.BasicRule("MPHB.Rules.MinAdvanceDaysRule", {}, {
			min: null,
			init: function(t) {
				this._super(t), this.min = t.min_advance_reservation
			},
			verify: function(t, e) {
				var a = l.datepick.add(MPHB.Utils.cloneDate(MPHB.HotelDataManager.myThis.today), this.min, "d");
				return MPHB.Utils.compareDates(a, t, "<=")
			}
				...
				return {
					...
					onDate: this.proxy(function(t, e) {
						var a = {
							...
							i = null !== this.getMaxAdvanceDate() && MPHB.Utils.compareDates(t, this.getMaxAdvanceDate(), ">"),
							n = MPHB.Utils.compareDates(t, this.getMinDate(), "<");
						e ? (!i && !n && MPHB.HotelDataManager.myThis.reservationRules.isCheckInSatisfy(t, this.roomTypeId) && MPHB.HotelDataManager.myThis.dateRules.canCheckIn(t) && (a.selectable = !0), a = MPHB.HotelDataManager.myThis.fillDateCellData(a, t, "checkIn")) : a.dateClass += " mphb-extra-date";
			...
			init: function(t, e) {
				this.checkInDatepickerEl = this.element.find('.mphb-datepick[id^="mphb_check_in_date"]'), this.checkOutDatepickerEl = this.element.find('.mphb-datepick[id^="mphb_check_out_date"]'), this.checkInDatepicker = new MPHB.SearchCheckInDatepicker(this.checkInDatepickerEl, {
					...
					form: this
				}), this.updateCheckInLimitations(), this.checkInDatepicker.getDate() && this.updateCheckOutLimitations()
			},
			updateCheckInLimitations: function() {
				var t = this.retrieveCheckInLimitations();
				this.checkInDatepicker.setOption("maxAdvanceDate", t.maxAdvanceDate)
			},
			updateCheckOutLimitations: function(t) {
				void 0 === t && (t = !0);
				var e = this.retrieveCheckOutLimitations(this.checkInDatepicker.getDate(), this.checkOutDatepicker.getDate());
		...
		var i = l("form.mphb_sc_search-form, form.mphb_widget_search-form, form.mphb_cb_search_form");
		l.each(i, function(t, e) {
			new MPHB.SearchForm(l(e))
		});
		var n = l(".mphb-flexslider-gallery-wrapper");
		l.each(n, function(t, e) {
			new MPHB.FlexsliderGallery(e)
		});
		var s = l(".mphb-checkout-terms-wrapper");
		0 < s.length && new MPHB.TermsSwitcher(s), null == l.ui && (l.ui = {}), null == l.ui.version && (l.ui.version = "1.5-")
	})
}(jQuery);